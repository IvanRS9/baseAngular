// To parse this data:
//
//   import { Convert, GiphyData } from "./file";
//
//   const giphyData = Convert.toGiphyData(json);
//
...
export class Convert {
  public static toGiphyData(json: string): GiphyData {
      return cast(JSON.parse(json), r("GiphyData"));
  }

  public static giphyDataToJson(value: GiphyData): string {
      return JSON.stringify(uncast(value, r("GiphyData")), null, 2);
  }
}
...
const typeMap: any = {
  "GiphyData": o([
      { json: "data", js: "data", typ: a(r("Datos")) },
